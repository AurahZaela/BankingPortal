...
<f:form action="saveDeposit" method="POST" modelAttribute="bankTransaction">  
<table border="1">
    ...
    <tr>
    <td> Select an Account to Deposit:</td>
    <td>
    ...
    <td> <f:input path="banktransactionType" value="${banktransactionType[0]}" readonly="true"/> </td>
